...
- Count of movies – a whole number in the range [1…20] 
...
[code-task title="Problem-05" taskId="pb-may-pr-05" executionType="tests-execution" executionStrategy="python-code" requiresInput]
