...
[code-task title="Biggest Number" taskId="p-xczxc01" executionType="tests-execution" executionStrategy="python-code" requiresInput]
...
[code-task title="Number Sequence" taskId="p-0qweqweee2" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Power of Number" taskId="p-034" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[slide]
# Problem: Equal Pairs
[code-task title="Equal Pairs" taskId="p-0p-0taskId4taskId4" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[slide]
# Problem: Zig Zag Sum
[code-task title="Zig Zag Sum" taskId="p-0p-055" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Divide Without Remainder" taskId="p-0sss6" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[slide]
# Problem: Vowel Sum
[code-task title="Vowel Sum" taskId="p-qweqwe07" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Rollercoaster" taskId="p-08-3" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[slide]
# Problem: Multiply
[code-task title="Multiply" taskId="p-09-2" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
