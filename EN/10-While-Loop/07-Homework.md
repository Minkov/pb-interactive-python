...
[slide]
# Problem: Sum Digits
[code-task title="Sum Digits" taskId="p-0asdasdq1" executionType="tests-execution" executionStrategy="python-code" requiresInput]
...
[code-task title="Favorite Book" taskId="p-0qweqwax2" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Special Number" taskId="taskIdp-04" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Special Bonus" taskId="p-05333p-05" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Sequence 2k + 1" taskId="psss-06" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Account Balance" taskId="p-eqweqw07" executionType="tests-execution" executionStrategy="python-code" requiresInput]
[code-editor language=python]
```
# Write your code here
```
