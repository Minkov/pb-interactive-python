...
[code-task title="Name and Expression" taskId="p-03" executionType="tests-execution" executionStrategy="python-code" ]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Calculations" taskId="p-04" executionType="tests-execution" executionStrategy="python-code" ]
[code-editor language=python]
```
# Write your code here
```
...
[code-task title="Square of 7 * 7 Stars" taskId="p-05" executionType="tests-execution" executionStrategy="python-code" ]
[code-editor language=python]
```
# Write your code here
```
